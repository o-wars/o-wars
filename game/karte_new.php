...
for ($row = mysql_fetch_array($result); $row ;$row = mysql_fetch_array($result)) {
	...
	$clans .= '<tr class="standard"><td align="center" onClick="clan('.$row['clanid'].', '.($map['end']/500-1).')"><a href="#">'.$name.'</a></td></tr>';
			...
			<table border="1" cellspacing="0" class="standard" style="width:135px">
				...
				<tr class="standard">
					<td align="center" class="standard">
						<a href="#" onclick="status('.($map['end']/500-1).', 10);">Neutral</a>
					</td>
				</tr>
				<tr class="standard">
					<td align="center" class="standard">
						<a href="#" onclick="status('.($map['end']/500-1).', 1);">Farmland</a>
					</td>
				</tr>
				<tr class="standard">
					<td align="center" class="standard">
						<a href="#" onclick="status('.($map['end']/500-1).', 2);">Feindlich</a>
					</td>
				</tr>
				<tr class="standard">
					<td align="center" class="standard">
						<a href="#" onclick="status('.($map['end']/500-1).', 3);">NAP/BND</a>
					</td>
				</tr>
				<tr class="standard">
					<td align="center" class="standard">
						<a href="#" onclick="status('.($map['end']/500-1).', 4);">mein Clan</a>
					</td>
				</tr>
				<tr class="standard">
					<td align="center" class="standard">
